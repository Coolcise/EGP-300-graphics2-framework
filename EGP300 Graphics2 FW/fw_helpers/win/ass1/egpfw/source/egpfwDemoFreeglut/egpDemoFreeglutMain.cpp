///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
////	EGP Graphics Framework Demo using Freeglut
////	By Dan Buckstein
////	January 2017
////
...
unsigned int viewport_tw;
unsigned int viewport_th;
float win_aspect;
...
void drawToBackBuffer()
{
	...
	glViewport(viewport_nb, viewport_nb, viewport_tw, viewport_th);
}
...
int initGame()
{
	...
	egpSetCloseKey(win_close, (void(*)())glutLeaveMainLoop);
